...
const Inbox: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark pb-32">
      <header className="p-6 bg-white dark:bg-surface-dark border-b border-gray-100 dark:border-gray-800">
      ...
      <main className="p-4">
        {userChats.length === 0 ? (
          ...
          <div className="space-y-4">
            {userChats.map(chat => {
              const proId = chat.participants.find(p => p !== state.currentUser?.id);
              ...
              return pro ? (
                ...
                >
                  <img src={pro.photo} className="size-14 rounded-full object-cover" alt="" />
